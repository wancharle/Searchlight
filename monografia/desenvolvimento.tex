...
\end{itemize}
	...
	Por convenção, o framework Searchlight utiliza o formato JSON como fonte de dados. A entrada dos dados pode ser feita localmente ou pela internet. Dados que não estejam no formato JSON devem ser processados conforme é mostrado na \autoref{fig-processamento}. 
