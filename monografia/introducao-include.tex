...
Alguns sites criam mecanismos que minimizam e, até certo ponto, conseguem resolver o problema da sobreposição de informações. Como exemplo, temos o \citeonline{crimemapatl}  mostrado na \autoref{fig-mapatl} que mostra um mapa com a taxa de crimes em Atlanta. 
...
O processo de agrupamento é em tempo real, e um pouco lento,  podendo ser observado no primeiro segundo após a mudança de zoom se o computador do observador não for muito rápido. 
